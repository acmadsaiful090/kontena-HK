...
Future<List<dynamic>> request({required RoomTaskRequest requestQuery}) async {
  String url;
  ...
  if (requestQuery.getParamID() != null) {
    ...
    url =
        '${AppState().domain}/api/resource/Room Task?${queryParams(requestQuery.formatRequest())}';
  }
